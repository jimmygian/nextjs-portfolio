...
import ExpCardDialogContextProvider from "@app/context/dialog-context";
...
export default function Experience() {
  ...
  return (
    <ExpCardDialogContextProvider>
      <section id="experience" className="mb-28 scroll-mt-28 sm:mb-40 text-center ">
