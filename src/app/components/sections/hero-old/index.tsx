    ...
    >
      ...
      <div className={`${hero.hero} flex justify-center items-start`}>
        <div className={`${hero.heroContent}`}>
          ...
          {/* Image */}
          <div
            className={`${animate.animate} ${animate.zoomIn} ${animate.anmDur04} flex items-center justify-center mt-[15vh] sm:mt-[30vh]`}
          >
          ...
          {/* Hero text */}
          <h1
            className={`${animate.animate} ${animate.up} ${animate.anmDur04} self-center text-center pt-2 text-xl xs:text-3xl landscape:sm:text-3xl sm:text-4xl ps-10 pe-10 max-w-[50rem] font-medium !leading-[1.5] xl:text-5xl xl:max-w-[65rem]`}
          >
