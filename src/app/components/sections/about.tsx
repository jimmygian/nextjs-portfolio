...
export default function About() {
  return (
    <section className={`${animate.animate} ${animate.up} ${animate.anmDur04} ${animate.anmDel05} ${animate.anmFillBck} mb-28 mx-10 max-w-[45rem] text-center leading-8 sm:mb-40`}>
